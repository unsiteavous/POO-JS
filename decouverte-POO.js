...
class Logement {
  // Underscore = c'est une variable privée
  _type;

  // CONSTRUCTEUR : est appelé quand on crée une nouvelle instance de cette classe avec le mot clé "new" 
  constructor(type){
    // Le mot clé "this" fait référence à la nouvelle instance, et utilise la notation dot pour attribuer la valeur reçue (type) à la clé correspondante (this._type)
